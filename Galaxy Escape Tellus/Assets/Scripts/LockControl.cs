...
public class LockControl : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {if (TiltFive.Input.TryGetButtonDown(TiltFive.Input.WandButton.A, out buttonDowna, TiltFive.ControllerIndex.Right, TiltFive.PlayerIndex.Three)){
            ...
            if(TiltFive.Input.TryGetButtonDown(TiltFive.Input.WandButton.B, out  buttonDownb, TiltFive.ControllerIndex.Right, TiltFive.PlayerIndex.Three)){

            
            if(TiltFive.Input.TryGetButtonDown(TiltFive.Input.WandButton.X, out  buttonDownx, TiltFive.ControllerIndex.Right, TiltFive.PlayerIndex.Three)) {
                if (buttonDownb){
